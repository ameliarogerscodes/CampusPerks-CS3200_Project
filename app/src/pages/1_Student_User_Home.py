...
try:
    response = requests.get("http://localhost:4000/discounts", params=params)
...
bookmarked_discounts = [d for d in discounts if d["discountId"] in st.session_state.bookmarks]
